...
if(isset($_POST['name']) && isset($_POST['email']) && isset($_POST['subject']) && isset($_POST['comment'])){
	...
	$mail->Username="abdullahisham32@gmail.com";  // Your Mail
	$mail->Password="99124325aA"; // Your app password

	$mail->setFrom($email, $name);  
	$mail->addAddress("abdullahisham32@gmail.com", "Abdulla Hisham"); // (Your Mail) An email address that will receive the email with the output of the form
